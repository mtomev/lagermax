<div id="nomedit" class="white-popup-block">
	...
	<div class="header">
		<span>Смяна на платформа по Авизо {$data.id}</span>
	</div>
	...
	<div style="float:left;clear:left;margin-top:10px;margin-bottom:20px;">
		...
		Действителната промяна в Авизото ще се извърши,
		<br>след записа на Авизото от следващия прозорец.
		</p>
	</div>
...
<script type="text/javascript">
	...
	$('#save_button').click (function () {
		...
		var url = '/aviso/aviso_edit/{$data.id}/'+$('#warehouse_id').val()+'/aviso_change_warehouse';
